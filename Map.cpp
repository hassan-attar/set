...
//template<typename KeyType, typename ValueType, PROBING ProbingMethod>
//const double Map<KeyType, ValueType, ProbingMethod>::DEFAULT_LOADING_FACTOR_THRESHOLD = 0.70;
//
//template<typename KeyType, typename ValueType, PROBING ProbingMethod>
//const PROBING Map<KeyType, ValueType, ProbingMethod>::DEFAULT_PROBING_METHOD = PROBING::LINEAR;
//
//template<typename KeyType, typename ValueType, PROBING ProbingMethod>
//const size_t Map<KeyType, ValueType, ProbingMethod>::DEFAULT_CAPACITY = 16;
//
//template<typename KeyType, typename ValueType, PROBING ProbingMethod>
//Map<KeyType, ValueType, ProbingMethod>::Map() : Map((size_t)DEFAULT_CAPACITY / 2){}
//
//template<typename KeyType, typename ValueType, PROBING ProbingMethod>
//Map<KeyType, ValueType, ProbingMethod>::Map(size_t numOfElement)
//        : hashTable{new std::pair<KeyType, ValueType>*[numOfElement * 2]}, size{0}, capacity{numOfElement * 2},
...
//
//template<typename KeyType, typename ValueType, PROBING ProbingMethod>
//Map<T, ProbingMethod>::Map(const std::initializer_list<T> &list): Map(list.size()) {
//    for(const T& x: list){
//        insert(x);
//    }
//}
